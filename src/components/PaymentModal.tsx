...
import { X, Upload, Camera, CheckCircle, Loader, Copy, CreditCard } from 'lucide-react';
          ...
          {step === 'instructions' && (
            <div className="space-y-6">
              ...
              <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                <h4 className="text-green-400 font-semibold mb-3">Payment Instructions:</h4>
              ...
              <div className="bg-gray-800/50 rounded-lg p-4">
                ...
                <div className="flex items-center justify-between bg-green-500/10 border border-green-500/30 rounded p-3">
                  <span className="text-green-400 font-mono font-bold text-lg">{jazzCashNumber}</span>
                  <button
          ...
          {step === 'processing' && (
            <div className="text-center space-y-6 py-8">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm mb-4">Our AI is verifying your payment screenshot...</p>
